...
CREATE SEQUENCE IF NOT EXISTS batch_step_execution_seq START  100;
CREATE SEQUENCE IF NOT EXISTS batch_job_execution_seq START  100;
CREATE SEQUENCE IF NOT EXISTS batch_job_seq START  100;
